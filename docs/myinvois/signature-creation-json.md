...
## H2: Step 1: Transform the document
...
## H2: Step 2: Calculate the document digest
...
## H2: Step 3: Sign the document digest using the certificate

The next step is to sign the property 
docdigest
 that is calculated in the previous step. This should be performed by loading the certificate to be used to sign the document as per the certificate generation guidance. Then use this certificate to sign the document digest value.
...
## H2: Step 4: Calculate the certificate digest
...
## H2: Step 5: Populate the signed properties section
...
## H2: Step 6: Calculate the signed properties section digest
...
## H2: Step 7: Create the signed JSON document
